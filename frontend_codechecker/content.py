    ...
    if exists:
        ...
        for assignment_dir_path in glob.glob(get_course_dir_path(course) + "*"):
            if os.path.isdir(assignment_dir_path):
                ...
                course_dict["assignments"].append([assignment_id, get_assignment_basics(assignment_id)])
...
def get_assignment_basics(course, assignment):
    ...
    exists = os.path.exists(file_path)
    assignment_dict = {"id": assignment, "title": "", "exists": exists, "course": get_course_basics(course), "problems": []}
...
def get_problem_basics(course, assignment, problem):
    ...
    exists = os.path.exists(file_path)
    problem_dict = {"title": "", "exists": exists, "assignment": get_assignment_basics(course, assignment)}
...
def get_problem_details(course, assignment, problem):
