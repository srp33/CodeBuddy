...
class AnswerQuestionHandler(BaseUserHandler):
        ...
        try:
            if self.is_administrator or await self.is_instructor_for_course(course_id) or await self.is_assistant_for_course(course_id):
                ...
                if question:
                    ...
                    self.render("answer_question.html", courses=self.courses, assignment_statuses=assignment_statuses,course_basics=course_basics, assignment_basics=assignment_basics, exercise_basics=exercise_basics, user_info=self.user_info, is_administrator=self.is_administrator, question=question, questioner_info=questioner_info, answerer_info=answerer_info, question_id=question_id)
                else:
    ...
    async def post(self, course_id, assignment_id, exercise_id, question_id):
        try:
            ...
            if smtp_server == "":
                return self.write("Success: Your answer has been received.")
            else:
