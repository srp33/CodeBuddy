    ...
    def get(self, course, assignment, exercise, student_id):
        try:
            if self.is_administrator or self.is_instructor_for_course(course) or self.is_assistant_for_course(course):
                ...
                self.render("view_request.html", courses=self.courses, course_basics=course_basics, assignments=self.get_assignments(course_basics), assignment_basics=assignment_basics, exercise_basics=self.get_exercise_basics(course_basics, assignment_basics, exercise), exercise_details=self.get_exercise_details(course_basics, assignment_basics, exercise), help_request=self.content.get_help_request(course, assignment, exercise, student_id), exercise_help_requests=self.content.get_exercise_help_requests(course, assignment, exercise, student_id), similar_requests=self.content.compare_help_requests(course, assignment, exercise, student_id), result=None, user_info=self.user_info, is_administrator=self.is_administrator, is_instructor=self.is_instructor_for_course(course), is_assistant=self.is_assistant_for_course(course))
            else:
    ...
    def post (self, course, assignment, exercise, student_id):
        try:
            if self.is_administrator or self.is_instructor_for_course(course) or self.is_assistant_for_course(course):
                ...
                self.render("view_request.html", courses=self.courses, course_basics=course_basics, assignments=self.get_assignments(course_basics), assignment_basics=assignment_basics, exercise_basics=self.get_exercise_basics(course_basics, assignment_basics, exercise), exercise_details=self.get_exercise_details(course, assignment, exercise), help_request=self.content.get_help_request(course, assignment, exercise, student_id), exercise_help_requests=self.content.get_exercise_help_requests(course, assignment, exercise, student_id), similar_requests=self.content.compare_help_requests(course, assignment, exercise, student_id), result=result, user_info=self.user_info, is_administrator=self.is_administrator, is_instructor=self.is_instructor_for_course(course), is_assistant=self.is_assistant_for_course(course))
            else:
                self.render("permissions.html")
        except Exception as inst:
            render_error(self, traceback.format_exc())
