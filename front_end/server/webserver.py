...
def make_app(settings_dict):
    app = Application(
        [
            ...
            url(r"/api/canvas/saved-credentials", CanvasSavedCredentialsHandler, name="canvas_saved_credentials"),
            url(r"/api/canvas/assignments", CanvasAssignmentsHandler, name="canvas_assignments"),
            url(r"/api/canvas/students", CanvasStudentsHandler, name="canvas_students"),
            url(r"/api/canvas/grades", CanvasGradesHandler, name="canvas_grades"),
            url(r"/api/canvas/submissions", CanvasSubmissionsHandler, name="canvas_submissions"),
            url(r"/api/canvas/course_gradebook/([^/]+)", CanvasCourseGradebookHandler, name="canvas_course_gradebook"),
            ...
            url(r"/email_students/([^/]+)/([^/]+)", EmailStudentsHandler, name="email_students"),
            ...
            url(r"/s/([A-Za-z0-9]+)", RedeemSecureAssignmentHandler, name="redeem_secure_assignment"),
            ...
            url(r"/secure_assignment/([^/]+)/([^/]+)", SecureAssignmentHandler, name="secure_assignment"),
