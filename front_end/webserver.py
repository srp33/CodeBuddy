...
class HomeHandler(RequestHandler):
    ...
    def get(self):
        try:
            ...
            self.render("home.html", courses=content.get_courses(show_hidden(self)), user_id=user_id, user_logged_in=user_logged_in_var.get(), role=content.get_role(user_id))
