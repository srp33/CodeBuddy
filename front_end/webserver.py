...
class EditPermissionsHandler(BaseUserHandler):
    def get(self):
        if is_administrator():
            try:
                self.render("edit_permissions.html")
            except Exception as inst:
                render_error(self, traceback.format_exc())
